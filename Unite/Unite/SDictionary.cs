...
namespace Unite
{
    ...
    public class SDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        public SDictionary() : this(0, null) { }

        public SDictionary(int capacity) : this(capacity, null) { }
        ...
        public SDictionary(IDictionary<TKey, TValue> dictionary) : this(dictionary, null) { }
        ...
        private static class PrimeHelper
        {
            ...
            1597, 1931, 2333, 2801, 3371, 4049, 4861, 5839, 7013, 8419, 10103, 12143, 14591, 17519, 21023, 25229, 30293, 36353,
            43627, 52361, 62851, 75431, 90523, 108631, 130363, 156437, 187751, 225307, 270371, 324449, 389357, 467237, 560689,
            672827, 807403, 968897, 1162687, 1395263, 1674319, 2009191, 2411033, 2893249, 3471899, 4166287, 4999559, 5999471,
            7199369
            };
        ...
        {
            private readonly SDictionary<TKey, TValue> _Dictionary;
            ...
            internal Enumerator(SDictionary<TKey, TValue> dictionary)
            {
